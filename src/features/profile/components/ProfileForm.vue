<template>
  ...
  >
    <header class="profile-form__header">
      ...
      <button class="profile-form__edit-button"
              type="button"
              :disabled="isEditing"
              @click="emit('edit')"
      >
    ...
    <div class="profile-form__fields">
      <BaseInput id="profile-first-name"
      ...
      <BaseInput id="profile-last-name"
    ...
    <p v-if="saveErrorMessage" class="profile-form__save-error" role="alert">
...
watch(() => props.userProfile, resetProfileForm, {
  deep: true,
  immediate: true,
})
