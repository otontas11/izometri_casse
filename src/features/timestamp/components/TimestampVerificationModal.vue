      ...
      >
        ...
        >
          <header class="timestamp-verification-modal__header">
            ...
            <div>
              <small>{{ t('timestamp.verification.eyebrow') }}</small>
              <h2 id="timestamp-verification-modal-title">
          ...
          >
            ...
            <p class="timestamp-verification-modal__demo-code">
              <span aria-hidden="true">
                <AppIcon name="wallet" :size="18" />
              </span>
              {{
                t('timestamp.verification.demoCode', {
                  code: DEMO_TIMESTAMP_VERIFICATION_CODE,
                })
              }}
            </p>
            ...
            >
              ...
              {{
                isSubmitting
                  ? t('timestamp.verification.verifying')
                  : t('timestamp.verification.confirm')
              }}
            </button>
...
const DEMO_TIMESTAMP_VERIFICATION_CODE = '123456'
...
const handleVerificationCodeSubmit = () => {
  ...
  if (enteredVerificationCode.value !== DEMO_TIMESTAMP_VERIFICATION_CODE) {
...
<style scoped src="./TimestampVerificationModal.css"></style>
