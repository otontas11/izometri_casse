const getTrimmedEnvironmentValue = (environmentValue?: string) =>
  environmentValue?.trim() ?? ''

export const environmentConfig = {
  apiBaseUrl:
    getTrimmedEnvironmentValue(import.meta.env.VITE_API_BASE_URL) ||
    'http://localhost:3001',
  ...
  auth0DatabaseConnection:
    getTrimmedEnvironmentValue(
      import.meta.env.VITE_AUTH0_DATABASE_CONNECTION,
