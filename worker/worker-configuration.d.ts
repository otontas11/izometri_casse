/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=worker/wrangler.jsonc worker/worker-configuration.d.ts` (hash: e8bca5b5ae1b0d7a1d009410f6484322)
// Runtime types generated with workerd@1.20260825.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	DOCUMENT_STORAGE: R2Bucket;
	DATABASE: D1Database;
	ALLOWED_ORIGINS: "http://localhost:5173,https://izimza.vercel.app";
	AUTH0_AUDIENCE: "https://izimza-case-api";
	AUTH0_DOMAIN: "dev-tnts.us.auth0.com";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "AUTH0_AUDIENCE" | "AUTH0_DOMAIN">> {}
}
